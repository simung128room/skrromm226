...
class PopupManager {
  ...
  fire(
    options: Omit<PopupOptions, "id" | "resolve">,
    ...
    >
      ...
      <div style={{ display: "flex", gap: 14 }}>
        ...
        <div style={{ flex: 1, paddingTop: 4 }}>
          <h3
            style={{ margin: 0, color: "#fff", fontSize: 14, fontWeight: 700 }}
          >
            {popup.title}
          </h3>
          {popup.text && (
          ...
          {popup.showCancelButton && (
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                color:
                  typeof popup.cancelButtonColor === "string" &&
                  popup.cancelButtonColor !== "#3b82f6"
                    ? "#fff"
                    : "#cbd5e1",
                fontSize: 12,
                fontWeight: 600,
